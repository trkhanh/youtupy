# -*- coding: utf-8 -*-
"""Library specific exception definations."""
from typing import Pattern
from typing import Union


class PytubeError(Exception):
    """Base pytube exceptoin that all orthers inherit

    This is done to bot pollute the built-in exceptions, which could result in
    unintended error being unexpectedly and incorrectly handler with implementer code.
    """
...
class RegexMatchError(ExtractError):
    """Regex pattern did not return any matcshes."""

    def __init__(self, caller: str, pattern: Union[str, Pattern]):
        """
        :param str caller: Calling function
        :param str pattern: Pattern that failed to match
        """
...
class LiveStreamError(VideoUnavailable):
    ...
    def __init__(self, video_id: str):
        """
        :param video_id: A Youtube video identifier.
        """
        self.video_id = video_id
