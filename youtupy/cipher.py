...
from youtupy.helpers import cache
from youtupy.helpers import regex_search
...
class Cipher:
    ...
    def get_transform_plan(js: str) -> List[str]:
        """Extact the "tranform plan"

            The "tranform plan" is the functions that the ciphered signature is cycle through to obtain the actual signature.
        ...
        logger.debug('getting tranform plan')
    ...
    def reverse(arr: List, _: Optional[Any]):
        """ Reverse elements in a list.
            ...
            This method take an unused ``b`` variable as their transform functions universally sent to arguments.
